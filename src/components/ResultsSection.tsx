      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
          ...
          <p className="font-['Manrope',sans-serif] text-sm sm:text-base text-[#94a3b8] max-w-md leading-relaxed">
            A convergência de disciplina individual com orientação técnica de excelência e biomecânica precisa.
          </p>
        </div>

        {STUDENT_RESULTS.length > 0 ? (
          <>
            {/* Filter Tabs */}
          ...
          <div className="p-10 sm:p-14 rounded-2xl bg-[#18181d] border border-dashed border-[#2a292e] text-center flex flex-col items-center justify-center gap-3">
            <span className="inline-flex p-3 rounded-full bg-[#ff5708]/10 text-[#ff5708] mb-1">
              <Sparkles className="w-6 h-6" />
            </span>
            <h3 className="font-['Oswald',sans-serif] text-xl sm:text-2xl uppercase text-[#e4e1e7] font-bold">
              Galeria de Resultados em Atualização
            </h3>
            <p className="font-['Manrope',sans-serif] text-sm text-[#94a3b8] max-w-md leading-relaxed">
              Os novos estudos de caso, fotos de evolução e depoimentos reais dos alunos estão em preparação e serão adicionados em breve.
            </p>
          </div>
        )}
      </div>
